 ...
 * incluyendo el producto de dos reales, el producto de dos enteros, el producto de tres números reales
...
private Producto producto;
    ...
    void testProductoDosReales() {
        ...
        assertEquals(6.25,resultado,"El producto de dos reales es incorrecto");
    }

    @Test
    void testProductoDosRealesNegativo() {
        double resultado = producto.productoDosReales(-2.0,2.0);
        assertEquals(-4.0,resultado,"El producto de dos reales con un numero negativo es incorrecto");
    }

    @Test
    void testProductoDosRealesCero() {
        double resultado = producto.productoDosReales(0,2.5);
        assertEquals(0,resultado,"El producto de dos reales con cero es incorrecto");
    }

    @Test
    void testProductoDosEnteros() {
        int resultado = producto.productoDosEnteros(2,2);
        assertEquals(4,resultado,"El producto de dos enteros es incorrecto");
    }

    @Test
    void testProductoDosEnterosNegativo() {
        int resultado = producto.productoDosEnteros(-2,2);
        assertEquals(-4,resultado,"El producto de dos enteros con un numero negativo es incorrecto");
    }

    @Test
    void testProductoDosEnterosCero() {
        int resultado = producto.productoDosEnteros(0,2);
        assertEquals(0,resultado,"El producto de dos enteros con cero es incorrecto");
    }

    @Test
    void testProductoTresReales() {
        double resultado = producto.productoTresReales(2.5,2.5,3.5);
        assertEquals(21.875,resultado,"El producto de tres reales es incorrecto");
    }

    @Test
    void testProductoTresRealesNegativo() {
        double resultado = producto.productoTresReales(-1.0,2.0,3.0);
        assertEquals(-6.0,resultado,"El producto de tres reales con un numero negativo es incorrecto");
    }

    @Test
    void testProductoTresRealesCero() {
        double resultado = producto.productoTresReales(0,2.5,3.5);
        assertEquals(0,resultado,"El producto de tres reales con cero es incorrecto");
    }
